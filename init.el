...
(use-package combobulate
  :pin manual
  :load-path "packages/combobulate"
  :hook
...
(with-eval-after-load 'python (progn (elpy-enable)
...
(use-package emacs-pde
  :defer t
  :pin manual
  :load-path "packages/emacs-pde/lisp"
  :commands run-perl
  :config
  (require 'pde-load))
...
(use-package eval-in-repl
  :load-path "packages/eval-in-repl"
  :config
...
(use-package eval-in-repl-ielm
  ...
  :after eval-in-repl
  :load-path "packages/eval-in-repl"
  :commands ielm eir-eval-in-ielm
  :bind
...
(use-package eval-in-repl-python
  ...
  :after eval-in-repl
  :load-path "packages/eval-in-repl"
  :commands ielm eir-eval-in-python
  :bind
...
(use-package poly-R
  :load-path "~/.emacs.d/packages/poly-R"
  :pin manual
  :after 'polymode
  :mode
...
(use-package poly-rst
  :load-path "~/.emacs.d/packages/poly-rst"
  :pin manual
  :after 'polymode)
...
;; pass text to the system clipboard without messing up the kill/yank ring.
(use-package simpleclip
  :load-path "~/.emacs.d/packages/simpleclip"
  :init (simpleclip-mode 1)
  :commands (simpleclip-mode))
